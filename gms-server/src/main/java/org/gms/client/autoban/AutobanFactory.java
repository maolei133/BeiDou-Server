...
public enum AutobanFactory {
    ...
    DAMAGE_HACK(20, SECONDS.toMillis(30), "篡改伤害"),
    ...
    PACKET_EDIT(1,SECONDS.toMillis(10),"封包编辑"),
    ACC_HACK("账号黑客"),
    ...
    VAC_SHORT_ITEM("短距离吸物"),
    VAC_ITEM(6, SECONDS.toMillis(15), "吸物"),
    VAC_MONSTER(10, SECONDS.toMillis(15), "吸怪"),
