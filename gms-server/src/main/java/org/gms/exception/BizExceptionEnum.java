...
public enum BizExceptionEnum implements BaseErrorInfoInterface {
    ...
    BODY_NOT_MATCH(10001, I18nUtil.getExceptionMessage("BODY_NOT_MATCH")),
    REQUEST_METHOD_SUPPORT(10001, I18nUtil.getExceptionMessage("REQUEST_METHOD_SUPPORT")),
    ILLEGAL_PARAMETERS(10001, I18nUtil.getExceptionMessage("ILLEGAL_PARAMETERS")),
    NOT_FOUND(40404, I18nUtil.getExceptionMessage("NOT_FOUND")),
