...
VALUES
    ...
    ('server', 'Game Mechanics', 'java.lang.Integer', 'hired_merchant_keep_days', '30', 'hired_merchant_keep_days'),
    ...
    ('server', 'Game Mechanics', 'java.lang.Integer', 'hired_merchant_save_interval', '10', 'hired_merchant_save_interval'),
...
VALUES
    ...
    ('zh-CN', 'game_config', 'hired_merchant_max_items', '雇佣商店最大上架物品数', null),
    ('en-US', 'game_config', 'hired_merchant_max_items', 'Hired Merchant Max Items', null),
    ...
    ('zh-CN', 'game_config', 'hired_merchant_save_interval', '雇佣商店自动保存间隔(分钟)', null),
    ('en-US', 'game_config', 'hired_merchant_save_interval', 'Hired Merchant Auto Save Interval (minutes)', null),
