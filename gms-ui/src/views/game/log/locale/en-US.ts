export default {
  'log.manager.title': 'Log Management',
  'log.manager.breadcrumb.game': 'Game',
  ...
  'log.manager.form.majorCategory.placeholder':
    'Please select a major category',
  'log.manager.form.minorCategory.label': 'Minor Category',
  'log.manager.form.minorCategory.placeholder':
    'Please select a minor category',
  ...
  'log.category.major.item': 'Item',
  'log.category.major.economy': 'Economy',
  'log.category.major.system': 'System',
  'log.category.major.chat': 'Chat',
  'log.category.major.battle': 'Battle',
  'log.category.major.quest': 'Quest',
  'log.category.major.shop': 'Shop',
  'log.category.major.social': 'Social',
  'log.category.major.gm_command': 'GM Command',
  'log.category.major.error': 'Error',
  'log.category.major.security': 'Security',
