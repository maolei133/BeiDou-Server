export default {
  ...
  'log.manager.form.ip.placeholder': '请选择IP地址',
  'log.manager.form.mac.label': 'MAC地址',
  'log.manager.form.mac.placeholder': '请选择MAC地址',
  'log.manager.form.hwid.label': '硬件ID',
  'log.manager.form.hwid.placeholder': '请选择硬件ID',
  'log.manager.form.account.label': '账号',
  'log.manager.form.account.placeholder': '请选择账号',
  'log.manager.form.character.label': '角色名',
  'log.manager.form.character.placeholder': '请输入角色名',
  'log.manager.table.column.content': '日志内容',
  'log.manager.message.fetchError': '查询日志时发生错误',
  'log.manager.message.fetchMajorCategoriesError': '获取大类列表时发生错误',
  'log.manager.message.fetchMinorCategoriesError': '获取小类列表时发生错误',
  'log.manager.message.fetchUniqueValuesError': '获取筛选选项时发生错误',
  'log.manager.message.selectCategoryFirst': '请先选择日志大类和小类',

  // 日志大类翻译
  'log.category.major.player': '玩家',
  'log.category.major.item': '物品',
  'log.category.major.economy': '经济',
  'log.category.major.system': '系统',
  'log.category.major.chat': '聊天',
  'log.category.major.battle': '战斗',
  'log.category.major.quest': '任务',
  'log.category.major.shop': '商城',
  'log.category.major.social': '社交',
  'log.category.major.gm_command': 'GM命令',
  'log.category.major.error': '错误',
  'log.category.major.security': '安全',
  'log.category.major.cheat': '内置辅助',
